...
- Personal lease at £1,100/month gross today; fresh lease comparator at £700/month net
...
- **Buy-out central** £26,000 (45-50% of list, 3yr / 60k miles)
...
- **Insurance** £1,500/yr (BMW i4 average ~£1,430, Manchester postcode slightly above)
- **Service** £300/yr (range £180-£400, dealer end)
- **Tyres** £950 fitted set, 35k mile interval (premium EV-rated 19")
- **Cost of capital** 5% applied to *declining* book value (avg book value × rate each year)
...
- `tests/test_models.py` — pytest suite (17 tests). Covers each cost component, the ECS
